...
def plot_expedia_figure3():
    """Plot Hat Q_min vs N from statistics CSV (same layout as synthetic Figure 3)."""
    ...
    save_path = (
        f"Figure3_DROPL_vs_N_Q_min_{exp_cfg.SETTING}_{exp_cfg.EXPEDIA_SPLIT_MODE}.pdf"
    )
